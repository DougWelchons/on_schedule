    ...
    describe "When I visit the project new page" do
      describe "Happy Path" do
        ...
        it "creates a new project and redirects to the project show page" do
          ...
          fill_in :start_date, with: Date.now
          fill_in :end_date, with: Date.now + 25
          click_button "Create Project"

          expect(User.all.last.name).to eq("New Project")
          expect(User.all.last.cmpany_id).to eq(@company.id)
